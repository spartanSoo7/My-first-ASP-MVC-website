    ...
    public class AccountController : Controller
    {
      ...
      //  [AllowAnonymous]
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {                                                                    //new data
                    ...
                    //changed so only admin can register new users, so auto login after registration is removed
                    // WebSecurity.Login(model.UserName, model.Password);
                    TempData["notice"] = "New User Has Been Successfully registered!";
        ...
        private void SendEMail(string emailid, string subject, string body)
        {
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("kanewardle.soo7@gmail.com", "Kane");
            client.UseDefaultCredentials = false;
            client.Credentials = credentials;

            MailMessage msg = new MailMessage();
            msg.From = new MailAddress("kanewardle.soo7@gmail.com");
